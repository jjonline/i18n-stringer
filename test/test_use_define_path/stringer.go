...
// _Code_defaultLocale default locale generated pass by i18n-stringer flag -defaultlocale, Don't assign directly
...
//  - args optional formatting component
func (i Code) WrapWithContext(err error, ctx context.Context, args ...Code) *I18nCodeErrorWrap {
...
func (e *I18nCodeErrorWrap) Trans() string {
	return e.origin.Trans(e.locale, e.args...)
}

// Lang alias of Trans
func (e *I18nCodeErrorWrap) Lang() string {
	return e.Trans()
}
...
// _Test_defaultLocale default locale generated pass by i18n-stringer flag -defaultlocale, Don't assign directly
...
//  - args optional formatting component
func (i Test) WrapWithContext(err error, ctx context.Context, args ...Test) *I18nTestErrorWrap {
...
// Trans get translated string
func (e *I18nTestErrorWrap) Trans() string {
	return e.origin.Trans(e.locale, e.args...)
}

// Lang alias of Trans
func (e *I18nTestErrorWrap) Lang() string {
	return e.Trans()
}
...
// _Single_defaultLocale default locale generated pass by i18n-stringer flag -defaultlocale, Don't assign directly
...
//  - args optional formatting component
func (i Single) WrapWithContext(err error, ctx context.Context, args ...Single) *I18nSingleErrorWrap {
...
// Trans get translated string
func (e *I18nSingleErrorWrap) Trans() string {
	return e.origin.Trans(e.locale, e.args...)
}

// Lang alias of Trans
func (e *I18nSingleErrorWrap) Lang() string {
	return e.Trans()
}
